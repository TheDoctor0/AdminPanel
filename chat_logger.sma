...
public plugin_init() 
{
	...
	register_cvar("chat_logger_host", "127.0.0.1", FCVAR_SPONLY|FCVAR_PROTECTED);
	register_cvar("chat_logger_user", "user", FCVAR_SPONLY|FCVAR_PROTECTED);
	register_cvar("chat_logger_pass", "pass", FCVAR_SPONLY|FCVAR_PROTECTED);
	register_cvar("chat_logger_base", "db", FCVAR_SPONLY|FCVAR_PROTECTED);
	register_cvar("chat_logger_server", "Test", FCVAR_SPONLY|FCVAR_PROTECTED);
